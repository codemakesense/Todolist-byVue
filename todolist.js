...
var todoContent = new Vue({
    ...
    data: {
        todoWorkLists: [
            {key: 0, index: 0, visible: true, type: "work", isfinished: false, title: "定一个写Vue应用的小目标" },
            {key: 1, index: 1, visible: true, type: "work", isfinished: false, title: "定一个晚上12点前睡觉的小目标" },
            {key: 2, index: 2, visible: true, type: "work", isfinished: false, title: "定一个明年2月份前换工作的小目标",  },
            {key: 3, index: 3, visible: true, type: "work", isfinished: false, title: "定一个学会Vue、ES6和Node.js技术栈的小目标",  },
            {key: 4, index: 4, visible: true, type: "work", isfinished: false, title: "这个应用已经阶段性完成，后面继续调试即可",  },
